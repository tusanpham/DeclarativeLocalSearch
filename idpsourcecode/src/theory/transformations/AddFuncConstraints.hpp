...
// NOTE: it's important to add all functions in the vocabulary as well, since even for an empty theory,
// functions constraints are important. E.g., counting the number of models over a vocabulary, or in my case,
// propagating over function symbols not present in the theory.
// So in some cases, one wants as few function constraints as possible, in others, all of them.
// TODO: find the optimal case.
